...
## Support the Federal Government and Local Authorities
This App is primarily for the research and development of defensive measures through the gathering of Intelligence necessary for the safety of the community. This application is to assist https://fbi.gov as well as https://cia.gov only if/when necessary to ensure the United States of the proper regulation in connection to the Crypto currency echange. This is to assist with the utilizations in a fair and safe manor equally. At any time either the CIA  or FBI may be monitoring any wallets directly connected to this application as allowed to do so by myself. Thank you for your support. God Bless.
